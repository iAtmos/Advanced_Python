...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Boris\Desktop\IF\Python\Python Advanced\1.2\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Boris\Desktop\IF\Python\Python Advanced\1.2\venv\Scripts\deactivate.nu'
